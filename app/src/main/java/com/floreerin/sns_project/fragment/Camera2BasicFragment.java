...
package com.floreerin.sns_project.fragment;
...
import com.floreerin.sns_project.view.AutoFitTextureView;
    ...
    private void setUpCameraOutputs(int width, int height) { // CameraCharacteristics.LENS_FACING_FRONT
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing == facingid) { // facingid가 0일 경우 전면 카메라로 변경
